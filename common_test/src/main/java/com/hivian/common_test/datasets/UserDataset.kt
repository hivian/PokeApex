...
object UserDataset {
    ...
    val FAKE_POKEMONS = listOf(
        Pokemon(name="pokemon1", height = 50, weight = 100, abilities = listOf("ability1"),
        ...
        Pokemon(name="pokemon2", height = 50, weight = 200, abilities = listOf("ability2"),
        ...
        Pokemon(name="pokemon3", height = 50, weight = 300, abilities = listOf("ability3"),
